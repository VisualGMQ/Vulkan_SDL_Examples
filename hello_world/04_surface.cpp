/*
 * this file include how to create surface
 */
#include <string>
#include <vector>
#include <iostream>
...
class App {
 ...
 private:
    ...
    void createSurface() {
        // SDL supply this function to create surface, so you don't need platform-dependent function to create surface.
...
int main(int argc, char** argv) {
    App app;
    app.SetTitle("04 create surface");
    app.Run();
    return 0;
}
